...
public class ExpressionTest {
  ...
  public void multiplicative0() {
    ...
    assertEquals(BinaryOperation.class,
        ((BinaryOperation) ((BinaryOperation) root).right).getClass());
    assertEquals(Operation.OperationType.MULTIPLY,
        ((BinaryOperation) ((BinaryOperation) root).right).type);

    assertEquals(Literal.class, ((BinaryOperation) ((BinaryOperation) root).right).left.getClass());
    assertEquals(2,
        ((Literal) ((BinaryOperation) ((BinaryOperation) root).right).left).value.value);

    assertEquals(Literal.class,
        ((BinaryOperation) ((BinaryOperation) root).right).right.getClass());
    assertEquals(3,
        ((Literal) ((BinaryOperation) ((BinaryOperation) root).right).right).value.value);
  }
  ...
  public void access0() {
    ...
    assertEquals(Operation.OperationType.ACCESS,
        ((BinaryOperation) ((BinaryOperation) ((Call) root).variable).left).type);
    assertEquals(Variable.class,
        ((BinaryOperation) ((BinaryOperation) ((Call) root).variable).left).left.getClass());
    assertEquals("a",
        ((Variable) ((BinaryOperation) ((BinaryOperation) ((Call) root).variable).left).left)
            .qualifiedName);
    assertEquals(Variable.class,
        ((BinaryOperation) ((BinaryOperation) ((Call) root).variable).left).right.getClass());
    assertEquals("b",
        ((Variable) ((BinaryOperation) ((BinaryOperation) ((Call) root).variable).left).right)
            .qualifiedName);
    ...
    assertEquals(Literal.class, ((Call) root).arguments.get(0).root.getClass());
    assertEquals(String.class,
        ((Literal) ((Call) root).arguments.get(0).root).value.value.getClass());
    assertEquals("Hello", ((Literal) ((Call) root).arguments.get(0).root).value.value);
